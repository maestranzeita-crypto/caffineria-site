...
const CATEGORIES = [
  ...
  },
  {
    ...
    accent: '#3C2415',
    items: [
      { name: 'Lasagna alla Bolognese', price: '8,00 €' },
      { name: 'Melanzane alla Parmigiana', price: '9,00 €' },
      { name: 'Cous Cous con Pollo Grigliato', price: '7,00 €' },
      { name: 'Cous Cous alle Verdure', price: '6,00 €' },
